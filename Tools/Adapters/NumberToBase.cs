...
namespace Tools.Adapters
{
    ...
    public class NumberToBase
    {
        ...
        public NumberToBase(string digits, bool shouldSupportRoundTripping = false)
            : this(digits.ToCharArray(), shouldSupportRoundTripping)
        {
        }

        public NumberToBase(IEnumerable<char> digits, bool shouldSupportRoundTripping = false)
        {
            if (digits == null)
            {
